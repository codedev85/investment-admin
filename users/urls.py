...
from .views import RegisterView, LoginView, UserView, LogOutView, ActivateAccountView, InvestmentPlanListView, \
    InvestmentPlanView, SubscribeToInvestmentPlanView, UserWalletDetailsView, UserWalletFundingView, \
    UserFetchTransactionView, UserWalletWithdrawalView, TokenVerificationView, ValidateActivationCodeView, \
    GetSubscriptionPlanChartView, TransactionSummaryView
